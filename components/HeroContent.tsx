    ...
    <AnimatePresence>
      <div className="z-[20] flex flex-col items-center justify-center h-full w-full text-white">
        ...
        <motion.h1
          ...
          className="absolute bottom-[300px] md:bottom-[255px] text-[60px] md:text-[86px] z-[30] font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 yellow-shadow"
        >
          Metamorphosis
        </motion.h1>
      </div>
